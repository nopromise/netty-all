package com.netty.study._02time;

import com.netty.study._02time.handler.SimpleTimeClientHandler;
import com.netty.study._02time.handler.TimeDecode2;
import com.netty.study._02time.handler.TimeDecoder;
...
//                    ch.pipeline().addLast(new SafeTimeClientHandler());
                    ...
                    ch.pipeline().addLast(new TimeDecoder(), new SimpleTimeClientHandler());
